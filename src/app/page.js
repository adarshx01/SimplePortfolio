    ...
    return (
      <>
        ...
        <button className='right-8 mt-10 fixed  bottom-6 rounded-full w-42 h-12 z-50'><a href='/contact'>Get in touch</a></button>
          ...
          <h1 className='lg:mt-60 lg:text-5xl lg:right-96 sm:mt-20 sm:text-3xl sm:w-36 sm:right-8 absolute text-black font-extrabold'>I`&apos`m Adarsh </h1>
          <h1 className='lg:mt-80 lg:text-5xl lg:right-60 sm:mt-40 sm:text-3xl sm:w-32 sm:right-12 absolute text-black font-bold'>A Web Developer</h1>
        </div>
        <div>
        </div>
